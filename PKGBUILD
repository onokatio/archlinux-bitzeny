...
pkgname=bitzeny-core
pkgver=2.0.1
pkgrel=1
pkgdesc="bitzenyd & bitzeny-tx & bitzeny-cli"
...
makedepends=('autoconf'
             ...
             'systemd')
license=('MIT')
source=(https://github.com/BitzenyCoreDevelopers/bitzeny/archive/z${pkgver}.tar.gz
        bitcoin.conf
        bitcoin.logrotate
        bitcoin.service
...
sha256sums=('9e7658df07b2ad7e114bbcd573676db90441f778c4ed3b5aefe0d4808707e9f9'
